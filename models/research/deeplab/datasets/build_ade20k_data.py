...
tf.app.flags.DEFINE_string(
    ...
    './ADE20K/ADEChallengeData2016/annotations/training2',
...
tf.app.flags.DEFINE_string(
    ...
    './ADE20K/ADEChallengeData2016/annotations/validation2',
...
def main(unused_argv):
    folder = parser.parse_args().date
    print(folder)
    FLAGS.output_dir = f'../../../../vis/tf/{folder}'
    if (not os.path.isdir(FLAGS.output_dir)) or (len(os.listdir(FLAGS.output_dir)) != 4):
        tf.gfile.MakeDirs(FLAGS.output_dir)
        _convert_dataset('val', f'/opt/LSC_DATA/{folder}', f'/opt/LSC_DATA/{folder}')
        exit()
